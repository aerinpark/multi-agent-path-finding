...
def a_star(my_map, start_loc, goal_loc, h_values, agent, constraints):
    ...
    # Limit the time horizon of the search using the upperbound
    # calculated based on the size of the environemnt.
    ...
    while len(open_list) > 0:
        ...
        for dir in range(4):
            ...
            # Ensure that the agents are moving within the environment
        ...
        # Task 1.1.3: When generating child nodes, ensure to add a child node where the agent waits
        # in its current cell instead of moving to a neighbouring cell
